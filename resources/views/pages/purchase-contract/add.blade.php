...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-2" style="margin-top: 3%;">
            <a href="{{ route('purchase-contract') }}">
        ...
        <div class="col-lg-5" style="text-align: center;">
            <h3 class="page-header">Manage Purchase Contract</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="panel-body">
        <form action="{{ route('purchase-contract.store') }}" method="post">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" id="datepicker" name="expiry_date" class="form-control" value="<?php echo date('d-m-Y') ; ?>">
            </div>
            <div class="form-group col-md-4">
