...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('igp-cylfill.report_customer') }}" style="position: absolute;margin-top: 16px;">
                <i class="glyphicon glyphicon-arrow-left"></i> Back  
            </a>
            <h3 style="text-align: center;">Alliance Energy (Pvt.) Ltd.</h3>
            <h5 style="text-align: center;">(Customer-Wise) IGP Cylinder-Filling </h5>
            ...
            <div class="clearfix">
                <div class="pull-right tableTools-container">
                    <a href="{{ url('igp-cylfill/distpdf?from_date='.$from_date.'&to_date='.$to_date.'&distributor_id='.$distributor_id) }}">
