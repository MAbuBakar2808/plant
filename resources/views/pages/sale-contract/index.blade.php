...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Purchase Contract Register</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b>All Records of "Purchase Contarct"</b>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body" style="overflow-x: scroll;
                    ...
                    id="dataTables-example">
                        ...
                        @foreach($sale_contract as $contract)
                            <tbody id="myTable">
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a class="green" href="{{ route('sale-contract.edit',
                                        	['id'=>$contract->id]) }}">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        </a>
                                        <a id="trash" onclick="return confirm('Are you sure to delete this?')"
                                             href="{{ route('sale-contract.delete',
                                        	['id'=>$contract->id]) }}">
